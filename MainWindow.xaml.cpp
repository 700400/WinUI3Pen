...
void winrt::WinUI3Pen2::implementation::MainWindow::myWrite_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    // Open for write
    FILE* fw;
    errno_t err;
    err = fopen_s(&fw, "D:/Winui3/my.txt", "w");// +, ccs = UTF - 8");
    if (err == 0)
    {
...
void winrt::WinUI3Pen2::implementation::MainWindow::myRead_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    // Open for write
    FILE* fr;
    errno_t err;
    err = fopen_s(&fr, "D:/Winui3/my.txt", "r");// +, ccs = UTF - 8");
    if (err == 0)
    {
        //  MessageBox(NULL, L"The file was opened\n", L"hi1", NULL);
        vx.clear();
...
void winrt::WinUI3Pen2::implementation::MainWindow::CanvasControl_PointerEntered(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::PointerRoutedEventArgs const& e)
{
    CanvasControl canvas = sender.as<CanvasControl>();
    canvas.Invalidate();
}
...
void winrt::WinUI3Pen2::implementation::MainWindow::myClear_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    vx.clear();
    vy.clear();
    col.clear();
...
void winrt::WinUI3Pen2::implementation::MainWindow::MenuFlyoutItem_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    vx.clear();
    vy.clear();
    size.clear();
...
void winrt::WinUI3Pen2::implementation::MainWindow::MenuFlyoutItem_Click_1(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    //저장
    FILE* fp;
    fopen_s(&fp, "D:/Winui3/my.txt", "w");
...
void winrt::WinUI3Pen2::implementation::MainWindow::MenuFlyoutItem_Click_2(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    //불러오기
    FILE* fp;
    fopen_s(&fp, "D:/Winui3/my.txt", "r");
...
void winrt::WinUI3Pen2::implementation::MainWindow::MenuFlyoutItem_Click_3(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
